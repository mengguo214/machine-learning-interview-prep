# Description: 
#   This script shows Kernel density estimator
#
# Details:
#     Kernel density estimation (KDE) is a non-parametric way to estimate the probability density function of a random variable.
#     Definition: Given a kernel K and a positive number h, called the bandwidth, the kernel density estimator is defined to be
#                 hat.f(x)  = 1/n sum(1/h*K*((x-Xi)/h))
# 
# License: GNU v3
#
...
plot(f, type = "l", xlab ="", ylab = "", main = "", lwd = 3,
     xaxt = "n", yaxt = "n", bty = "n", xlim = c(-10, 10))
